@testset "Interval-based discretisation tests" begin
    ...
    @testset "Quantile bounds for unbounded distributions" begin
        ...
        discrete_exp_custom = discretize(
            exp_dist, 0.1; min_quantile = 0.01, max_quantile = 0.95)
    ...
    @testset "Interval properties and consistency" begin
        ...
        if length(widths) > 1
            ...
            uniform_width_indices = findall(
                w -> abs(w - mean_width) < 0.1 * mean_width, widths)
